    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_image', models.ForeignKey(blank=True, help_text='Best size for \t\t\t\t  this image will be 1000x1000', null=True, on_delete=django.db.models.deletion.SET_NULL, to='wagtailimages.image')),
            ],
            options={
                'abstract': False,
            },
